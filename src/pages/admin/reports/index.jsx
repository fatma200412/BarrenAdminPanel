      ...
      <div className={style.eventsPages}>
        ...
        <div className={style.eventsAndSearch}>
          <div className={style.btns}>
            ...
            <button>Customers (0)</button>
            <button>Tickets (1)</button>
            <button>Payouts (1)</button>
          </div>
          ...
          <div className={style.filter}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={4}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value={"Refunded Rejected"}>Refunded Rejected</MenuItem>
                    <MenuItem value={"Refunded Requnded"}>Refunded Requnded</MenuItem>
              ...
              <Grid item xs={12} md={4}>
                <FormControl fullWidth>
                  <InputLabel id="demo-simple-select-label">All Orders</InputLabel>
                  <Select
                    labelId="demo-simple-select-label"
                    id="demo-simple-select"
                    value={activeOrders}
